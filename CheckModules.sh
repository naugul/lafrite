...
grep '\<CONFIG_NETFILTER_XT_MATCH_L2TP\>' /boot/config-`uname -r`
grep '\<CONFIG_L2TP\>' /boot/config-`uname -r` 
grep '\<CONFIG_L2TP_DEBUGFS\>' /boot/config-`uname -r` 
grep '\<CONFIG_L2TP_V3\>' /boot/config-`uname -r` 
grep '\<CONFIG_PPPOL2TP\>' /boot/config-`uname -r`
